    ...
    <div className="p-6 max-w-9/12 mx-auto">
      ...
      <div className="flex justify-between items-center mb-8 relative">
        ...
        <div className="hidden lg:block">
          <Image src="/diamond.png" alt="Page Logo" width={69} height={69} />
        </div>
            ...
            {dropdownOpen && (
              <div className="absolute mt-2 right-0 rounded text-black bg-white shadow-lg z-10">
                {LANGUAGES.map((l) => (
                  ...
                  >
                    <span>{l.name}</span>
                    <Image src={l.flag} alt={l.name} className="rounded-sm" width={28} height={28} />
                  </div>
                ))}
              </div>
            )}
      ...
      <div className="mb-4 flex flex-col items-center">
        ...
        <button className="font-bold mb-8 mt-14 py-4 bg-green-600 text-white rounded-full">
          {navLabels[7]}
        </button>
      </div>
    </div>
